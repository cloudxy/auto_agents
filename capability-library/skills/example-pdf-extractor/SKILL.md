...
description: "示例 skill：从 PDF 中提取表格和正文文本。用于验证 capability-library 骨架（symlink 分发、meta.yaml 治理字段、索引、后台）是否跑通，非真实生产 skill。"
---

# Example PDF Extractor（示例）

这是 capability-library 骨架搭建阶段用的占位示例，用来验证：
