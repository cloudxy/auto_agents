...
const ROLE_PERMISSIONS: Record<string, string[]> = {
  admin: ['menu:dashboard', 'menu:spiders', 'menu:spiders.tasks', 'menu:spiders.logs', 'menu:spiders.nodes', 'menu:users', 'menu:data', 'menu:settings', 'menu:ai', 'menu:skills', 'menu:members', 'menu:usage', 'menu:llm', 'menu:newapi', 'menu:logs', 'btn:create', 'btn:delete', 'btn:schedule', 'btn:skill:edit', 'btn:skill:admin'],
