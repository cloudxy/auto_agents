...
def test_list_users_includes_tenant_name(db_client, platform_admin_client, _seed):
...
def test_create_user_with_role_and_tenant(db_client, platform_admin_client, _seed):
    """创建账户：角色 + 归属公司；密码不入响应"""
...
def test_create_user_duplicate_username_rejected(db_client, platform_admin_client, _seed):
...
def test_create_user_same_name_in_platform_tenant_allowed(db_client, platform_admin_client, _seed):
...
def test_update_user_role(db_client, platform_admin_client, _seed):
...
def test_update_self_demotion_rejected(db_client, platform_admin_client, _seed):
...
def test_delete_user_soft_and_guardrails(db_client, platform_admin_client, _seed):
